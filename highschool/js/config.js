...
const CONFIG = {
  ...
  FIELD: {
    ...
    /* 全国大会はこちらの表を使う。平均は +6.1 で、自軍の伸びより速い。
       地方大会の決勝から全国大会の1回戦へは期待値を動かさないので、
       全国大会の重さはこの表だけで作っている。
       勝ち進むほど苦しくなり、勝ち切れるのは10回に1回ほどになる */
    NAT_STEP: [
      { weight:  8, add: [-1.0,  2.5] },   // 楽な回
      { weight: 22, add: [ 2.5,  5.0] },
      { weight: 34, add: [ 5.0,  7.0] },   // ふつう
      { weight: 26, add: [ 7.0,  9.0] },
      { weight: 10, add: [ 9.0, 12.0] },   // 妙に強い回
    ],
