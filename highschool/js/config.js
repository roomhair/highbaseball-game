...
const CONFIG = {
  ...
  FIELD: {
    ...
    /* 全国大会はこちらの表を使う。平均は +8.4 で、自軍の伸び（+2.7）より
       ずっと速い。地方大会の決勝から全国大会の1回戦へは期待値を
       動かさないので、全国大会の重さはこの表だけで作っている。
       勝ち進むほど苦しくなり、勝ち切れるのは10回に1回ほどになる */
    NAT_STEP: [
      { weight:  8, add: [-0.5,  4.9] },   // 楽な回
      { weight: 22, add: [ 4.9,  7.4] },
      { weight: 34, add: [ 7.4,  9.4] },   // ふつう
      { weight: 26, add: [ 9.4, 11.4] },
      { weight: 10, add: [11.4, 14.4] },   // 妙に強い回
    ],
